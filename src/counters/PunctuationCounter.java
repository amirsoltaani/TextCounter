...
/**
 * This class output a distinct list of all punctuation in the file along with their counts.
 * The results are sorted based on punctuation occurrence from most frequent to least frequent.
